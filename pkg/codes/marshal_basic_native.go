...
func marshalBasicNative(observe byte, input interface{}) (buf []byte, err error) {
	...
	case reflect.Float32:
		buf, err = marshalFloat32(observe, input)
	...
	case reflect.Array, reflect.Slice:
		...
		//fmt.Printf("#222 marshalBasicNative observe=%#x\n", observe)
		//switch reflect.ValueOf(input).Index(0).Elem().Kind() {
		switch reflect.ValueOf(input).Index(0).Kind() {
		case reflect.String:
...
func marshalFloat32(observe byte, input interface{}) (buf []byte, err error) {
